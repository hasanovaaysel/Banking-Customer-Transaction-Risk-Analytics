...
last_names = ["Hasanova","Aliyeva","Muxtarova","Agayeva","Mammadova","Ismayilova","Huseynova",
"Rahimova","Quliyeva","Abbasova","Aslanova","Muradova","Isayeva","Tagiyeva","Alizada"]

cities = ["Baku","Ganja","Sumqayit","Mingachevir","Shaki","Lankaran","Quba","Gabala","Nakhchivan"]



customer_data = []

segments = ["Mass Market","Mass Affluent","Premium","Private"]
...
channels = ["Branch","ATM","Mobile App","Internet Banking","POS"]
...
complaint_categories = [ "Card Issue","Transaction Problem","Loan Issue","Account Issue","Customer Service",
"ATM Problem","Mobile Banking"]
...
campaign_names = [
    "Premium Upgrade","Salary Account","Credit Card Cashback","Personal Loan",
    "Home Loan","Digital Banking","Savings Boost","Investment Campaign"
]
...
with pd.ExcelWriter("banking_analyticss.xlsx", engine="openpyxl") as writer:
